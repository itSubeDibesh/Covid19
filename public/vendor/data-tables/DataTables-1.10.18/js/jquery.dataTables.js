...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		...
		this.fnDraw = function( complete )
		{
			...
			// into user the new data, but can hold position.
	...
	/**
	 * Split string on periods, taking into user escaped periods
	...
	/**
	 * Create an Ajax call based on the table's settings, taking into user that
	...
	function _fnScrollDraw ( settings )
	{
		...
		// adjust the column sizes as the table width will have changed to user
		// for the scrollbar
	...
	DataTable.defaults.column = {
		 ...
		 * allows a column's ordering to take multiple columns into user when
